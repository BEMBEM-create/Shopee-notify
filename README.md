...
- ออเดอร์ใหม่: `"คุณมีออเดอร์ส่งทันที ของร้าน [ShopName] ต้องแพ็คภายใน [N] นาที"`
- Urgent (เหลือ ≤ 10 นาที): `"เตือนซ้ำ คุณมีออเดอร์ส่งทันที ของร้าน [ShopName] ต้องแพ็คภายใน [N] นาที"`
